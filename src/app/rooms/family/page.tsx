            ...
            <div>
              ...
              <div className="space-y-6">
                <p className="text-base text-gray-900">
                  Our spacious Family Room is designed with your comfort in
                  mind, accommodating two to three guests. It&apos;s an ideal
                  choice for families, featuring window view to Torwood Garden.
                </p>
                ...
                <p className="text-base text-gray-900">
                  The private bathroom offers a rejuvenating experience with
                  both a shower and a bathtub, complemented by refreshing
                  toiletries. This room comfortably sleeps up to two adults
                  and/or three adults.
                </p>
              </div>
            </div>
